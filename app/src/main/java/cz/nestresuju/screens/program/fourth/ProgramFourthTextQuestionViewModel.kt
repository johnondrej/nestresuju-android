 ...
 */
class ProgramFourthTextQuestionViewModel(
    ...
    private fun updateResults(currentResults: ProgramFourthResults, answer: String): ProgramFourthResults {
        return when (progress) {
            1 -> currentResults.copy(stressEvent = answer)
            2 -> currentResults.copy(positives = answer)
