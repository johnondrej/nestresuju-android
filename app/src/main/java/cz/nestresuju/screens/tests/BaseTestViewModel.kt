...
/**
 * Base ViewModel for input/output tests.
 */
abstract class BaseTestViewModel : BaseViewModel() {
    ...
    protected abstract suspend fun fetchTestQuestions(): List<InputTestQuestion>

    protected abstract suspend fun submitTestResults(results: List<InputTestQuestionAnswer>)
